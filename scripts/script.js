...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const previewSection = document.getElementById('previewSection'); // Declare the preview section

    generateButton.addEventListener("click", () => {
        // Show the preview section when Generate Build is clicked
        previewSection.style.display = "block";

        // Call the function to generate the Chris plaque
        generateChrisPlaque();
    });
    ...
    function generateChrisPlaque() {
        ...
        // Display the generated content in the output section
